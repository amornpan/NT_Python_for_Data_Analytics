...
- [📖 Lending Club Business Guide](#-lending-club-business-guide)
- [🔧 การใช้งาน](#-การใช้งาน)
...
📁 **[lending_club_guide/](./lending_club_guide/)** - คู่มือครบชุด 10 ไฟล์

#### 📚 **ไฟล์หลัก**
- [📖 README.md](./lending_club_guide/README.md) - ภาพรวมคู่มือ Lending Club
- [🏢 01_lending_club_overview.md](./lending_club_guide/01_lending_club_overview.md) - ภาพรวม Lending Club
- [🔄 02_business_model.md](./lending_club_guide/02_business_model.md) - โมเดลธุรกิจ P2P Lending
- [📊 03_dataset_overview.md](./lending_club_guide/03_dataset_overview.md) - ข้อมูลที่ใช้ในหลักสูตร
- [🔍 04_key_variables.md](./lending_club_guide/04_key_variables.md) - ตัวแปรสำคัญและความหมาย
- [🎯 05_business_questions.md](./lending_club_guide/05_business_questions.md) - Business Questions ทุกประเภทการวิเคราะห์
- [💡 06_case_studies.md](./lending_club_guide/06_case_studies.md) - Case Studies และการประยุกต์ใช้
- [🎓 07_course_applications.md](./lending_club_guide/07_course_applications.md) - การประยุกต์ใช้ในหลักสูตร
- [🏋️ 08_exercises.md](./lending_club_guide/08_exercises.md) - แบบฝึกหัดและโจทย์ปฏิบัติ
- [📈 09_learning_outcomes.md](./lending_club_guide/09_learning_outcomes.md) - ผลลัพธ์การเรียนรู้
- [💡 10_tips_and_resources.md](./lending_club_guide/10_tips_and_resources.md) - เคล็ดลับและแหล่งเรียนรู้
- [📋 data_dictionary_complete.md](./lending_club_guide/data_dictionary_complete.md) - Data Dictionary ครบถ้วน (143 ตัวแปร)
...
#### 🚀 **วิธีการใช้งาน**
1. **เริ่มต้น**: อ่าน [README.md](./lending_club_guide/README.md) เพื่อเข้าใจภาพรวม
...
6. **ใหม่**: อ่าน [Lending Club Guide](./lending_club_guide/README.md) เพื่อเข้าใจบริบทธุรกิจ
...
> 📖 **ใหม่**: อ่าน [Lending Club Business Guide](./lending_club_guide/README.md) เพื่อเข้าใจบริบทธุรกิจก่อนเริ่มเรียน